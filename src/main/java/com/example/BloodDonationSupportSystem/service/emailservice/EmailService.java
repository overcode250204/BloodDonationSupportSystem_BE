...
public class EmailService {
    ...
    public void sendHealthReminder() throws MessagingException {
            MimeMessage message = mailSender.createMimeMessage();

            // true = multipart
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");

            helper.setTo("lephatkhoinguyen25022004@gmail.com");
            helper.setSubject("Nhắc nhở theo dõi sức khỏe sau hiến máu");

            // Cả plain text và HTML (để client tự chọn)
            helper.setText("Xin chào Nguyen,\n" +
                    "\n" +
                    ...
                    "\n" +
                    "    <p>Xin chào <strong>Nguyen</strong>,</p>\n" +
                    "\n" +
            ...
            helper.setFrom("trganhtuan.dev@gmail.com");
